    ...
    <div v-if="data">
        <div class="weather-item" v-for="item in data" :key="item.id">
            ...
            <div class="weather-item__сontent-temp">
                <img class="weather-item__img" :src="`http://openweathermap.org/img/wn/${item.icon}.png`" alt="">
            ...
            <div class="weather-item__content">
                <div class="content__item content__item_recede">
                    <span class="weather-item__feels">Feels like: {{
                        temp(item.feels_like)
                    }}&deg;c</span>
                    <span class="weather-item__clouds">{{ capitalised(item.clouds) }}</span>
                </div>
                <div class="content__item content__item_line">
                    <span class="weather-item__wind">
                        ...
                        {{ item.wind }}
                        m/s</span>
                    <span class="weather-item__pressure"><i class="fa-solid fa-weight-hanging"></i>{{ item.pressure }}
                        hPa</span>
                </div>
                <div class="content__item content__item_line">
                    <span class="weather-item__humidity"><i class="fa-solid fa-droplet"></i> {{
                        item.humidity
                    }} %</span>
                    <span class="weather-item__visibility"><i class="fa-solid fa-binoculars"></i> {{
